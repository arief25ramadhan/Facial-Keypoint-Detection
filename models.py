...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # Remember that in the 1. Load .ipynb we already transform the image into 224x224 pixel size
    ...
    def forward(self, x):
        ...
        # 6 convolutional and pooling layer
        x = self.pool(F.relu(self.conv1(x)))
        ...
        # this code is similar to Flatten in Keras
        x = x.view(x.size(0), -1)
